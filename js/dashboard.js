...
window.showAIModal = function (type, subject) {
    ...
    const syllabiDB = {
        ...
        'Internet and Web Technology': genSyllabusHTML([
            { title: 'Unit 1: Introduction', desc: "Concept of WWW, HTTP Protocol: request and response, web browser architecture, web servers and application servers, features of Web 2.0, internetworking with TCP/IP, basics of DNS, SMTP, POP3." },
            { title: 'Unit 2: Web Design', desc: "Concepts of effective web design, planning and publishing website. Introduction to web architecture. HTML: lists, tables, images, frames, forms. Document Type Definition (DTD), Document Object Model (DOM). Cascading Style Sheets (CSS) and their types. JavaScript: introduction, documents, forms, statements, functions, objects." },
            { title: 'Unit 3', desc: "Introduction to XML, XML vs HTML, uses of XML, simple XML, XML key components, DTD and schemas. Embedding XML into HTML documents. Transforming XML using CSS, XSL, and XSLT." },
            { title: 'Unit 4: PHP', desc: "Working with variables and constants, controlling program flow. Working with functions, arrays, files, and directories. Working with forms and databases. Introduction to Servlet lifecycle, API, and Servlet packages." },
            { title: 'Unit 5', desc: "Introduction to Java Server Pages (JSP). JSP application design, JSP objects. Conditional processing, declaring variables and methods. Sharing data between JSP pages. Sharing session and application data. Database programming using JDBC. Web application framework, MVC framework. Introduction to Bootstrap and AngularJS." }
        ]),
