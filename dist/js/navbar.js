...
function updateNavbarAuthButton(basePath) {
    ...
    const checkAuth = () => {
        ...
        if (isLoggedIn) {
            ...
            profileBtn.style.background = userPhoto ? 'transparent' : 'linear-gradient(135deg, #7b61ff, #00f2ff)';
            profileBtn.style.borderColor = userPhoto ? 'rgba(255,255,255,0.5)' : '#ffffff';
            profileBtn.style.boxShadow = '0 0 20px rgba(0, 242, 255, 0.4)';
