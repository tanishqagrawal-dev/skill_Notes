...
import { globalNotes } from '../data/globalNotes.js?v=mtj49zwp-lwnd';
import { renderCodingArena } from './coding-arena.js?v=mtj49zwp-lwnd';
import { RoutingSystem } from './routing.js?v=mtj49zwp-lwnd';
import { initGlobalAnalytics } from './analytics.js?v=mtj49zwp-lwnd';
...
import { supabase } from './supabase-config.js?v=mtj49zwp-lwnd';
...
function renderAITools() {
    ...
    return `
        <div id="ai-coach-tab" class="tab-pane active fade-in" style="padding: 0; width: 100%; height: calc(100vh - 160px); display: flex; justify-content: center; align-items: flex-start; box-sizing: border-box; background: transparent; overflow: hidden;">
            ...
            <style>
                ...
                .msg-bubble ul, .msg-bubble ol { margin: 0 0 10px 0; padding-left: 20px; }
                .msg-bubble li { margin-bottom: 4px; }
                .msg-bubble strong { color: #fff; font-weight: 700; }
                .msg-bubble code { background: rgba(255,255,255,0.1); padding: 2px 6px; border-radius: 4px; font-family: monospace; font-size: 0.9em; }
                .msg-bubble pre { background: #000; padding: 12px; border-radius: 8px; overflow-x: auto; margin: 10px 0; border: 1px solid #333; }
            ...
            <div class="ai-premium-container">
                ...
                <div class="ai-input-wrapper">
                    <form id="ai-chat-form" onsubmit="window.handleAIChatSubmit(event)" class="ai-input-container">
                        ...
                        <textarea id="ai-chat-input" placeholder="Message AI..." rows="1" oninput="this.style.height = ''; this.style.height = Math.min(this.scrollHeight, 150) + 'px';" onkeydown="if(event.key === 'Enter' && !event.shiftKey) { event.preventDefault(); window.handleAIChatSubmit(new Event('submit')); }"></textarea>
            ...
            <div class="note-card-pro card-reveal" data-note-id="${sequentialId}" style="animation-delay: ${idx * 0.1}s;">
                <div class="note-info-pro">
                    ...
                    <div class="meta-pills-row-pro">
                        <div class="meta-pill-pro uploader-pro" style="color: var(--secondary); font-weight: 600;">
                             <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                             ${note.uploaderName || note.uploader || 'SKiL MATRiX'}
                        </div>
                        <div class="meta-pill-pro date-pro" style="color: #2ecc71; font-weight: 600; background: rgba(46, 204, 113, 0.1);">
                             <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                             Premium Verified
                        </div>
                    </div>
                    <div class="note-actions-pro">
                        <div style="display: flex; align-items: center; gap: 0.5rem; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); padding: 0.4rem 0.8rem; border-radius: 8px; color: var(--text-dim); font-size: 0.85rem; font-weight: 700;">
